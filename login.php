...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<img src="dist/img/evoting2.png" width=250px />
			<br>
			<a href="login.php">
				Sistem
				<b><i>e - Voting</i></b>
				<h6>Pemilihan Ketua Badan Eksekutif Mahasiswa (BEM)
</h6>
				<h5><i>Institut Tekhnologi dan Sains Mandala</i>
</h5>
			</a>
		</div>
		<!-- /.login-logo -->
		<div class="card">
			<div class="card-body login-card-body">
				<p class="login-box-msg">Login System <i>e-Vote</i></p>
